...
gui_palette_qt5::initialize ()
{
    ...
    m_palette.add(SEQ64_COLOR(GREY),        m_grey,     "Gray");        // hmmmm

    m_palette.add(SEQ64_COLOR(DK_BLACK),    m_dk_black, "Dk Black");    // hmmmm
    ...
    m_palette.add(SEQ64_COLOR(DK_YELLOW),   m_yellow,   "Dk Yellow");
    ...
    m_palette.add(SEQ64_COLOR(DK_WHITE),    m_dk_white, "Dk White");    // hmmmm
    m_palette.add(SEQ64_COLOR(DK_ORANGE),   m_dk_orange, "Dk Orange");
    m_palette.add(SEQ64_COLOR(DK_PINK),     m_dk_pink,  "Dk Pink");
    m_palette.add(SEQ64_COLOR(DK_GREY),     m_dk_grey,  "Dk Grey");     // hmmmm
    ...
    m_pen_palette.add(SEQ64_COLOR(GREY),    m_black, "black");
    ...
    m_pen_palette.add(SEQ64_COLOR(DK_YELLOW), m_black, "black");
